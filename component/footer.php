...
$this->options->dark_setting;  ?>
  ...
  <footer id="footer" class="app-footer" role="footer">
    <div class="wrapper bg-light">
      ...
      <?php if (@in_array('showSettingsButton',$this->options->featuresetup) || $dark_setting == "auto")
          : ?>
