...
class Access_Plugin implements Typecho_Plugin_Interface
{
    ...
    public static function activate()
    {
        ...
        Helper::addPanel(1, self::$panel, _t('Access控制台'), _t('Access插件控制台'), 'editor');
    ...
    public static function render()
    {
        ...
        if ($options->plugin('Access')->showNavMenu && Typecho_Widget::widget('Widget_User')->pass('administrator',true)) {
            echo '<script>
